...
const Footer = () => {
    ...
    const flyTo = async (addressOrLatLng, zoom = 16) => {
        ...
        if (typeof addressOrLatLng === "string") {
            try {
                const result = await geocoderRef.current.geocode({ address: addressOrLatLng });
                if (result?.results?.[0]) {
        ...
        <footer className="footer-container">
            ...
            <div className="footer-top">
                <div className="footer-top-item">
                    ...
                    <div className="footer-top-text">
                        <h4 className="find-us-link" onClick={handleOpenMap}>Find us</h4>
            ...
            <div className="footer-main">
                ...
                <div className="footer-col footer-about">
                    ...
                    <p>
                        ...
                        healthy, and delicious meals right to your doorstep. Our mission 
                        is to provide high-quality food from the best local restaurants.
                    </p>
                </div>
                ...
                <div className="footer-col">
                    ...
                    <ul className="footer-links">
                        ...
                        <li><a href="#freshfood">Fresh Food</a></li>
                        <li><a href="#bakery">Bakery & Snacks</a></li>
                ...
                <div className="footer-col">
                    ...
                    <ul className="footer-links">
                        ...
                        <li><a href="#quality">Quality Checks</a></li>
                ...
                <div className="footer-col footer-social-connect">
                    ...
                    <div className="footer-social-icons">
                        <a href="#"><img src="/social-media-png/facebook.png" alt="Facebook" /></a>
                        <a href="#"><img src="/social-media-png/instagram.png" alt="Instagram" /></a>
                        <a href="#"><img src="/social-media-png/twitter.png" alt="Twitter" /></a>
                        <a href="#"><img src="/social-media-png/linkedin.png" alt="LinkedIn" /></a>
                        <a href="#"><img src="/social-media-png/whatsapp.png" alt="WhatsApp" /></a>
                    </div>
            ...
            >
                <DialogTitle sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <IconButton onClick={handleCloseMap}><CloseIcon /></IconButton>
                </DialogTitle>
                <DialogContent dividers>
                    <div className="map-controls">
                        <Button onClick={prevBranch} size="small" variant="outlined">Prev</Button>
                        <span className="map-branch-name">{branches[branchIndex]}</span>
                        <Button onClick={nextBranch} size="small" variant="outlined">Next</Button>
                    </div>
                    {apiKey ? (
                        ...
                        <div className="map-iframe-wrapper">
                            <iframe
                                ...
                                src={`https://www.google.com/maps?q=${encodeURIComponent(branches[branchIndex])}&output=embed`}
                                loading="lazy"
                                allowFullScreen
                            />
                        </div>
